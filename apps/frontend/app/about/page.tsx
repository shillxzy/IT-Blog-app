...
export const metadata: Metadata = {
  ...
  description: "IT Blog — незалежне українське медіа про технології. Дізнайтесь про нашу редакцію, місію та редакційну політику.",
};

// force-dynamic so this doesn't fail at build time if API is unavailable
    ...
    <main className="about-page">
      ...
      <section className="about-section">
        ...
        <div className="about-values">
          {[
            { icon: "🎯", title: "Практичність", text: "Жодної теорії заради теорії. Кожна стаття містить реальний код, кейси або покроковий гід." },
            { icon: "🇺🇦", title: "Українською", text: "Весь контент створюється українською мовою. Технічний жаргон пояснюється зрозуміло." },
            { icon: "✅", title: "Перевірено", text: "Статті публікуються лише після технічної перевірки. Застарілий контент оновлюється." },
          ].map((v) => (
      ...
      <section className="about-section about-section-alt">
        ...
        <ul className="about-policy-list">
          ...
          <li>Помилки в статтях виправляються протягом 48 годин після повідомлення.</li>
      ...
      {authors.length > 0 && (
        <section className="about-section">
          ...
          <div className="about-team-grid">
            {authors.map((author) => (
              <Link key={author.id} href={`/authors/${author.slug}`} className="about-team-card">
                {author.avatar && (
                  <Image
                    src={author.avatar}
                    alt={author.name}
                ...
                <div>
                  ...
                  <p className="about-team-count">{author.articlesCount} статей</p>
                </div>
              </Link>
            ))}
          </div>
      ...
      <section className="about-section">
        ...
        <div className="about-contacts">
          ...
          <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="about-contact-link">
            GitHub організація
          </a>
        </div>
      </section>
